...
class StyledPlot:
    ...
    def __init__(self):
        ...
        plt.rc('axes', labelsize=12, titlesize=12, grid=False)
        plt.rc('legend', fontsize=8)
        plt.rc('image', cmap=DEFAULT_CMAP)
    ...
    def subplots(self, cols=1, rows=1, **kwargs):
        return self.plt.subplots(nrows=rows, ncols=cols, figsize=(0.8 * FIG_WIDTH*cols, 0.8 * FIG_HEIGHT*rows), dpi=200, **kwargs)
